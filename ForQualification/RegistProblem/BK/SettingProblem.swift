...
class SettingProblem: UIViewController, UITextViewDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.navigationItem.title = NaviTitle.problemRegist
        photoExplanationLabel.text = "タップして\n画像を選択してください"
...
extension SettingProblem: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func showAlert() {
        ...
        let alertController = UIAlertController(title: ButtonTitle.Photo.selected, message: "どちらを使用しますか？", preferredStyle: .actionSheet)
